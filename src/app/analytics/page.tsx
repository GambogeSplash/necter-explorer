...
import { BarChart3, Activity, Cpu, Download } from "lucide-react";
import {
  AreaChart,
  Area,
  BarChart,
  ...
  return (
    <div className="px-2.5 py-2 space-y-4">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <StatCard title="Total Staked" value="45.2M" change="+2.3%" trend="up" icon={BarChart3} />
        ...
        <div className="px-5 py-4">
          <ResponsiveContainer width="100%" height={200}>
            <BarChart data={computeUtilization}>
              ...
              <Bar dataKey="value" fill="#9985FF" radius={[4, 4, 0, 0]} name="Utilization" />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </div>
